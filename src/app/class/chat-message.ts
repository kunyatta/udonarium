...
export interface ChatMessageContext {
  ...
  sendFromIdentifier?: string; // ----- MODIFICATION (kunyatta) for Chat Message Source Identifier -----
}
...
export class ChatMessage extends ObjectNode implements ChatMessageContext {
  ...
  @SyncVar() sendFromIdentifier: string; // ----- MODIFICATION (kunyatta) for Chat Message Source Identifier -----
